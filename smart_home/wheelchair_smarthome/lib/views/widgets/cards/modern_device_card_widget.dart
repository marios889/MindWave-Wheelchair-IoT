...
class ModernDeviceCard extends StatefulWidget {
  final SmartDevice device;
  final VoidCallback? onTap;

  const ModernDeviceCard({super.key, required this.device, this.onTap});

  @override
  State<ModernDeviceCard> createState() => _ModernDeviceCardState();
}

class _ModernDeviceCardState extends State<ModernDeviceCard> {
  ...
  String _getDeviceIcon(DeviceType type) {
    switch (type) {
      ...
      case DeviceType.Device:
        return "assets/images/socket.png";
                          ...
                          children: [
                            ...
                            Switch(
                              ...
                              onChanged: (value) async {
                                ...
                                for (int i = 0; i < 3; i++) {
                                  widget.device.type == DeviceType.lamp
                                      ? UdpService.sendUDP(
                                          value ? "O10" : "C10",
                                          widget.device.ip,
