...
# The smart home environment utilizes independent ESP-12F nodes equipped with non-blocking firmware (`safeDelay()`) to ensure physical wall switches remain operational even if the Wi-Fi network drops. 
...
# This system was engineered as a Graduation Project for the \*\*Faculty of Engineering at Shoubra, Benha University (Class of 2026)\*\* by:

# 

# \* \*\*Alaa Essam Rezk\*\*

# \* \*\*Mario Magdy Michel\*\* \* \*\*Kyrillos Atef Botros\*\* \* \*\*Marios Maged Atef\*\*

# \* \*\*Yasmeen Essam Sobhy\*\* \* \*\*Madonna Atef Shafiq\*\* \* \*\*Mariam Elia Aziz\*\*

# 

# \*\*Supervisors:\*\* Dr. Michael Nassif, Dr. Christina Gamal, Assoc. Prof. Dr. Walaa Goda.
